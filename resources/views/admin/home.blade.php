                    ...
                    <div class="filter d-flex dashboard-filter-btn">
                        <span style="font-size: large; font-weight: bold;"><i class="far fa-grip-vertical"></i>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('dashboard.yesterday') }}">Yesterday</a>
                                </li>
                                {{--  <li><a class="dropdown-item" href="#">Last 7 days</a></li>
                                    <li><a class="dropdown-item" href="#">Last 30 days</a></li>  --}}
                                <li><a class="dropdown-item" href="{{ route('dashboard.month') }}">This Month</a></li>
                                <li><a class="dropdown-item" href="{{ route('dashboard.previous_month') }}">Last
                                        Month</a></li>
                                <li><a class="dropdown-item" href="{{ route('dashboard.yearly') }}">This Year</a></li>
                                <li><a class="dropdown-item" href="{{ route('dashboard.previous_year') }}">Last Year</a>
                                </li>
