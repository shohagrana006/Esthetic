...
<nav class="main-header topHeader navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" data-widget="pushmenu" id="sidebar-close" onclick="collapsNav()" href="#"
                role="button"><i class="fas fa-align-left"></i></a>
        </li>
    </ul>
    ...
    <ul class="navbar-nav ">
        ...
        <li class="admin-icon">
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle user-drop-btn" type="button" id="dropdownMenuButton1"
