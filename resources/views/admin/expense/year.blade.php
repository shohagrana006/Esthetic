...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Yearly Expense</h1>
                </div><!-- /.col -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    {{--  {{ strtoupper(date('Y')) }}  --}}
                                    Yearly EXPENSES LISTS
                                </h3>
                                <div class="float-sm-right">
                                    <p class="text-danger pull-right">Yearly Total Expenses : {{ $expenses->sum('amount') }} Taka</p>
