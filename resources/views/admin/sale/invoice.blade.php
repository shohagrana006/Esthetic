            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                                ...
                                {{$customer->customer_about_info }}<br>
                                {{--  {{ $customer->city }}<br>  --}}
                                Phone: (+880) {{  $customer->customer_phone_number }}<br>
                    ...
                    <div class="row no-print">
                        <div class="col-12">
                            <a href="{{ route('order.show', $customer->id) }}" target="_blank" class="btn btn-default">
                                <i class="fa fa-print"></i> Print</a>

                                <a href="{{ route('invoice.print', $customer->id) }}" target="_blank" class="btn btn-default">
                                    <i class="fa fa-print"></i> Print</a>
