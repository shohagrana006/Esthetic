        ...
        <div class="container">
            <div class="row mt-3">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <h3><strong>{{ date('d F Y') }} report </strong> </h3>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card-count">
                        <h5>Total Purchase <span>
                                <strong> <i class="fas fa-dollar-sign"></i>
                                    {{ $today_purchages->sum('purchage_quantity') }} Taka
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Total Expence<span>
                                <strong><i class="fas fa-dollar-sign"></i> {{ $today_expenses->sum('amount') }} Taka </strong>
                            </span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Total Stock <br> Sell Value <span>
                                <strong><i class="fas fa-dollar-sign"></i> {{ $today_product->sum('seling_price') }}</strong>
                            </span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Total Products <span>
                                <strong><i class="fas fa-dollar-sign"></i> {{ $today_product->sum('quantity') }}</strong>
                            </span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Damaged Products <span>
                                <strong><i class="fas fa-dollar-sign"></i>
                                   {{ $today_damage->sum('damage_quantity') }}
