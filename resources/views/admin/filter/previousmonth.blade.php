                    ...
                    <div class="card-count">
                        <h5>Total Purchase <span>
                                <strong> <i class="fas fa-dollar-sign"></i>
                                    {{ $previous_month_purchages->sum('purchage_quantity') }} Taka
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Total Expence<span>
                                <strong><i class="fas fa-dollar-sign"></i> {{ $previous_month_expenses->sum('amount') }} Taka
                                </strong>
                            </span>
                        </h5>
                    </div>
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Total Stock <br> Sell Value <span>
                                <strong><i class="fas fa-dollar-sign"></i>
                                    {{ $previous_month_product->sum('seling_price') }}</strong>
                            </span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Total Products <span>
                                <strong><i class="fas fa-dollar-sign"></i> {{ $previous_month_product->sum('quantity') }}</strong>
                            </span>
                        </h5>
                    </div>
                </div>
                ...
                <div class="single-card">
                    ...
                    <div class="card-count">
                        <h5>Damaged Products <span>
                                <strong><i class="fas fa-dollar-sign"></i>
                                    {{ $previous_month_damage->sum('damage_quantity') }}
